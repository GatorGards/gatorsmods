...
global.sprite = sprite_add_weapon(s + "soulmachinegun.png", 2, 2);
global.spriteHUD = sprite_add(s + "soulmachinegunHUD.png", 1, 0, 3);
global.muzzle = sprite_add(s + "muzzleflash.png", 1, 8, 8)

#define weapon_name					return "SOUL MACHINEGUN";
